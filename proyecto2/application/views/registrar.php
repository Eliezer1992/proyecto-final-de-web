	...
	<div class="login-page">
		<div class="container">
			...
			<div class="login-body">
				<form action="#" method="post">
					<input required type="text" class="" name="cedula" placeholder="Cedula" required="">
					<input required type="text" class="" name="Informacion" placeholder="Informacion" required="">
					<input required type="text" class="" name="name" placeholder="Nombre" required="">
					<input required type="text" class="" name="apellido" placeholder="Apellido" required="">
					<input required type="text" class="" name="telefono" placeholder="Telefono" required="">
					<input required type="text" class="" name="celular" placeholder="Celular" required="">
					<input required type="text" class="" name="fax" placeholder="Fax" required="">
					<input required type="text" class="user" name="correo" placeholder="Correo" required="">
					<input required type="password" name="password" class="lock" placeholder="Contraseña" required="">
