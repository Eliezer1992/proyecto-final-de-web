...
<body>
	...
	<div class="login-page">
		<div class="container">
			<h3 class="w3ls-title w3ls-title1">publicar Inmueble</h3>
			<div class="login-body">

				<form action="#" method="post">
						<div class="input-group form-group">
      						<span class="input-group-addon">Titulo</span>
      						<input type="text" name="titulo" autofocus="on" class="form-control">
      					</div>
						...
						<div class="input-group form-group">
						  ...
						  <label class="radio-inline"><input type="radio" name="optradio">Vender</label>
						  <label class="radio-inline"><input type="radio" name="optradio">Alquilar</label>
      					</div>
